sap.ui.define([
	...
	function (BaseController, JSONModel, MessageBox, Filter, FilterOperator) {
		...
		return BaseController.extend("treinamento.l4e.app.controller.ConsultaCalendario", {
			onInit: function () {
                this.getRouter().getRoute("ConsultaCalendario").attachPatternMatched(this.handleRouteMatched, this);
            ...
            handleRouteMatched: async function(){
                ...
                await
                $.ajax({
                    "url": "/apiNairobi/api/AgendaDoacoesSet",
                    "method": "GET",
                    success(data){
            ...
            onExcluir: async function(oEvent){
                ...
                await
                $.ajax({
                    "url": `/apiNairobi/api/AgendaDoacoesSet/${id}`,
                    "method": "DELETE",
                    success(data){
